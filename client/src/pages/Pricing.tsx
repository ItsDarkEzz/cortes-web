...
export default function Pricing() {
    useSEO({
        ...
        description: "Cortes полностью бесплатен во время бета-тестирования. Все функции доступны без ограничений: AI-ответы, модерация, память. Узнайте о будущих тарифах.",
        canonical: "/pricing",
    });
