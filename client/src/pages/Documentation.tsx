...
export default function Documentation() {
    useSEO({
        ...
        description: "Полное руководство по Cortes: как добавить бота в Telegram, настроить модерацию, использовать команды. Пошаговые инструкции с примерами.",
