...
export function Features() {
  ...
  const features = [
    ...
    {
      icon: Shield,
      title: "Модерация без спама",
      description: "Помогает с контролем токсичности и спама, но никогда не вмешивается без причины.",
      color: "text-cyan-400"
    },
    {
      icon: Zap,
      title: "Молниеносная реакция",
      description: "Обрабатывает сообщения за <50ms. Сверхбыстрый анализ, мгновенные ответы.",
      color: "text-yellow-400"
    },
    {
      icon: BarChart3,
      title: "RPG система",
      description: "Начисляет XP, раздает достижения, создает квесты и ведет таблицу лидеров.",
